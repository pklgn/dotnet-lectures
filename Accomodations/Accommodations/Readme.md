...
и положить в корень проекта. Название файла `fixes.txt`. Важно: скриншоты из предыдущего абзаца в виде ссылки на гугл док со всеми скриншотами прикрепляйте так же в конце файла `fixes.txt`
